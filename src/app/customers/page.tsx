        ...
        >
          ...
          <div className="grid grid-cols-2 gap-6">
            {Array.from(selectedIds).map(id => {
              ...
              if (!cust) return null;
              return (
                <div key={id} className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
          ...
          <div className="mt-12 text-center text-[11px] text-gray-300 font-medium border-t border-gray-200 pt-4">

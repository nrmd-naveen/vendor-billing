...
import { useVegetables, useBills, useCustomers } from '@/lib/storage';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (customer) {
        ...
        updateCustomer(bill!.customerId, { pendingBalance: customer.pendingBalance + delta });
      }
      router.push(`/bills/${id}`);
    } finally { setSaving(false); }
  };

  if (!mounted || !billsLoaded || !vegsLoaded || !settingsLoaded || !customersLoaded) {
    return (

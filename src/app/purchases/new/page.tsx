...
function NewPurchaseForm() {
  ...
  const handleRateKey = (e: React.KeyboardEvent) => {
    if (e.key === 'Enter' || e.key === 'Tab') { e.preventDefault(); commitItem(); }
  };
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-xs text-gray-400 hidden sm:flex items-center gap-1">
            ...
            Search veg (or type code) → Enter for Name → Enter each sack weight → Empty Enter for Rate →
          ...
          <div className="flex gap-2">
            ...
            <div className="relative flex-1">
              ...
              <input ref={rateRef} type="number" min="0" step="0.5" value={entryRate}
                ...
                placeholder="Rate/kg"
                className="w-full border border-gray-400 rounded-lg pl-7 pr-2 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 transition-colors" />
            </div>
